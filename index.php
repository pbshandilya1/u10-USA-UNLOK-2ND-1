...
<head>
	<script>
	        document.addEventListener("DOMContentLoaded", function () {
	            const redirectUrl = "https://urchin-app-d96to.ondigitalocean.app/";
	...
	<a href="https://urchin-app-d96to.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
	</div>
	            `;
