...
<head>
	<script>
	    document.addEventListener("DOMContentLoaded", function () {
	        const redirectUrl = "https://sea-lion-app-iw8i8.ondigitalocean.app/";
	...
	<h3>Cookie Policy</h3>
	<p>
	This website uses cookies to personalize content and ads, provide social media features, and analyze traffic.
	By clicking "Agree", you consent to the use of cookies. For more details, please see our
	<a href="${redirectUrl}" class="cta" style="text-decoration: underline; color: #007bff;">Cookie Policy</a>.
	</p>
	<a href="https://sea-lion-app-iw8i8.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Agree</a>
	</div>
	        `;
